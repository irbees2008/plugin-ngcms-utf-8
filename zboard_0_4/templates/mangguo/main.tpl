...
<div class="header">
	...
	<ul class="quick-menu clearfix">
		...
		<li class="subscribe"><a href="{{ home }}/login/">Р’С…РѕРґ</a></li>
		<li class="random"><a href="{{ home }}/register/">Р РµРіРёСЃС‚СЂР°С†РёСЏ</a></li>
		{% else %}
		<li class="random"><a href="{{ home }}/logout/">Р’С‹С…РѕРґ</a></li>
		{% endif %}
	</ul>
</div>
<div class="content">
{% if pluginIsActive('zboard') %}
	...
	<div class="tab">
		<ul class="clearfix">
<li class="menu-item menu-item-type-custom menu-item-object-custom {% if isHandler('news') %}current-menu-item{% endif %}"><a href="{{home}}">Р“Р»Р°РІРЅР°СЏ</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page {% if isHandler('zboard') and not isHandler('zboard:list') and not ( isHandler('zboard:send') or isHandler('zboard:edit') ) %}current-menu-item{% endif %}"><a href="{{home}}/plugin/zboard/">Р”РѕСЃРєР° РѕР±СЉСЏРІР»РµРЅРёР№</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom {% if isHandler('zboard:send') %}current-menu-item{% endif %}"><a href="{{home}}/plugin/zboard/send/">Р”РѕР±Р°РІРёС‚СЊ РѕР±СЉСЏРІР»РµРЅРёРµ</a></li>
{% if (global.flags.isLogged) %}
<li class="menu-item menu-item-type-post_type menu-item-object-page {% if (global.flags.isLogged) and ( isHandler('zboard:list') or isHandler('zboard:edit') ) %}current-menu-item{% endif %}"><a href="{{home}}/plugin/zboard/list/">РЎРїРёСЃРѕРє РјРѕРёС… РѕР±СЉСЏРІР»РµРЅРёР№</a></li>
{% endif %}
		</ul>
	</div>
	...
	<div class="quick-link">
		...
		<div class="clearfix">
			<div class="counter">Р’СЃРµРіРѕ РґРѕСЃС‚СѓРїРЅРѕ РѕР±СЉСЏРІР»РµРЅРёР№ <a href="{{home}}/plugin/zboard/"><b>{{ callPlugin('zboard.show_entries_cnt') }}</b></a></div>
		</div>
	</div>
{% endif %}
...
<li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="{{home}}">Р“Р»Р°РІРЅР°СЏ</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="{{home}}/plugin/zboard/">Р”РѕСЃРєР° РѕР±СЉСЏРІР»РµРЅРёР№</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="{{home}}/plugin/zboard/send/">Р”РѕР±Р°РІРёС‚СЊ РѕР±СЉСЏРІР»РµРЅРёРµ</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page"><a href="{{home}}/rss.xml">RSS</a></li>
		</ul>
		<a href="http://rostunov.com/" class="licence" title="РЎР°Р№С‚ СЃРґРµР»Р°РЅ РІ СЃС‚СѓРґРёРё РџСѓС€РёСЃС‚С‹С… РєРѕС‚РѕРІ. Р—Р° РєРѕРїРёСЂРѕРІР°РЅРёРµ СЃСЃС‹Рј РІ С‚Р°РїРєРё.">&copy; rostunov.com</a>
	</div>
</div>
</div>
