...
<input class="button" onmousedown="javascript:window.location.href='{{admin_url}}/admin.php?mod=extra-config&plugin=forum&action=addcat&do=cat'" value="Добавить категорию" />
</td>
</tr>
</tfoot>
<tr>
