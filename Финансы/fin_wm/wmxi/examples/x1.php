...
<form action="" method="post">
	...
	<input type="text" class="form-control" name="orderid" value="1"/>
	<br/>

	<label>WMId покупателя:</label>
	<input type="text" class="form-control" name="customerwmid" value=""/>
	<br/>

	<label>номер кошелька, на который необходимо оплатить счет:</label>
	<input type="text" class="form-control" name="storepurse" value=""/>
	<br/>
	...
	<input type="text" class="form-control" name="desc" value="тестирование X1 wmxi"/>
	<br/>

	<label>адрес доставки товара:</label>
	<input type="text" class="form-control" name="address" value="мой адрес не дом и не улица"/>
	<br/>
	...
	<input type="text" class="form-control" name="expiration" value="1"/>
	<br/>
