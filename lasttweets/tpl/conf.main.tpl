...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="50%" class="contentEntry2"><input type="text" class="form-control" size="15" name="twi_username" value="{twi_username}" /></td>
	</tr>
	...
	<tr id="search" {style_search}>
		...
		<td width="50%" class="contentEntry2"><input type="text" class="form-control" size="15" name="search" value="{search}" /></td>
	</tr>

	<tr>
		<td width="80%" class="contentEntry1">{l_lasttweets:label_GMT}<br /><small>{l_lasttweets:descr_GMT}</small></td>
		<td width="20%" class="contentEntry2"><input type="text" class="form-control" size="8" name="GMT" value="{GMT}" /></td>
	</tr>

	<tr>
		<td width="80%" class="contentEntry1">{l_lasttweets:label_count}<br /><small>{l_lasttweets:descr_count}</small></td>
		<td width="20%" class="contentEntry2"><input type="text" class="form-control" size="8" name="count" value="{count}" /></td>
	</tr>
</table>
</fieldset>
