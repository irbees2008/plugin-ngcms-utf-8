...
class SxGeo {
	...
	public function __construct($db_file = 'SxGeo.dat', $type = SXGEO_FILE){
		...
		// РЎРЅР°С‡Р°Р»Р° СѓР±РµР¶РґР°РµРјСЃСЏ, С‡С‚Рѕ РµСЃС‚СЊ С„Р°Р№Р» Р±Р°Р·С‹ РґР°РЅРЅС‹С…
		$header = fread($this->fh, 40); // Р’ РІРµСЂСЃРёРё 2.2 Р·Р°РіРѕР»РѕРІРѕРє СѓРІРµР»РёС‡РёР»СЃСЏ РЅР° 8 Р±Р°Р№С‚
		...
		if ($this->batch_mode) {
			$this->b_idx_arr = array_values(unpack("N*", $this->b_idx_str)); // Р‘С‹СЃС‚СЂРµРµ РІ 5 СЂР°Р·, С‡РµРј СЃ С†РёРєР»РѕРј
			unset ($this->b_idx_str);
			$this->m_idx_arr = str_split($this->m_idx_str, 4); // Р‘С‹СЃС‚СЂРµРµ РІ 5 СЂР°Р· С‡РµРј СЃ С†РёРєР»РѕРј
