...
$lang = array(
    ...
    "Cannot move uploaded file to target folder." => "No es pot moure el fitxer pujat al directori destГ­",
    "Unknown error." => "Error desconegut.",
    "The uploaded file exceeds {size} bytes." => "El fitxer seleccionat excedeix el pes mГ xim permГЁs ( {size} bytes ).",
    "The uploaded file was only partially uploaded." => "El fitxer seleccionat nomГ©s s'ha carregat parcialment.",
    "No file was uploaded." => "No s'ha carregat cap fitxer.",
    "Missing a temporary folder." => "Manca un directori temporal.",
    "Failed to write file." => "No s'ha pogut escriure el fitxer.",
    "Denied file extension." => "ExtensiГі de fitxer no permesa.",
    "Unknown image format/encoding." => "Format d'imatge desconegut.",
    "The image is too big and/or cannot be resized." => "La imatge Г©s massa gran i/o no es pot redimensionar.",
    "Cannot create {dir} folder." => "No s'ha pogut crear el directori {dir}",
    "Cannot rename the folder." => "No es pot reanomenar el directori.",
    "Cannot write to upload folder." => "No es pot escriure al directori de cГ rrega de fitxers.",
    ...
    "Cannot read upload folder." => "No s'ha pogut llegir la carpeta de cГ rrega de fitxers.",
    "Cannot access or create thumbnails folder." => "No s'ha pogut accedir o crear la carpeta de miniatures.",
    "Cannot access or write to upload folder." => "No s'ha pogut accedir o escriure la carpeta de cГ rrega de fitxers.",
    "Please enter new folder name." => "Si us plau, introduГЇu el nom del nou directori.",
    "Unallowable characters in folder name." => "CarГ cters no permesos en el nom del directori.",
    "Folder name shouldn't begins with '.'" => "El nom d'un directori no hauria de comenГ§ar amb un punt '.'",
    "Please enter new file name." => "Si us plau, introduГЇu el nom del nou fitxer.",
    "Unallowable characters in file name." => "CarГ cters no permesos en el nom del fitxer.",
    "File name shouldn't begins with '.'" => "El nom d'un fitxer no hauria de comenГ§ar amb un punt '.'",
    ...
    "Fileinfo PECL extension is missing." => "Manca arxiu d'informaciГі de l'extensiГі PECL.",
    "Opening fileinfo database failed." => "Error obrint el fitxer d'informaciГі de la base de dades.",
    ...
    "Copy files here" => "Copia els fitxers aquГ­",
    "Move files here" => "Mou els fitxers aquГ­",
    ...
    "Copy {count} files" => "Copia els {count} fitxers aquГ­",
    "Move {count} files" => "Mou els {count} fitxers aquГ­",
    ...
    "Download version {version} now!" => "Descarregueu la versiГі {version}!",
    "KCFinder is up to date!" => "KCFinder estГ  actualitzat!",
    "Licenses:" => "LlicГЁncies:",
    "Attention" => "AtenciГі",
    "Question" => "Pregunta",
    "Yes" => "SГ­",
    "No" => "No",
    "You cannot rename the extension of files!" => "No estГ  permГЁs canviar la extensiГі al fitxer.",
