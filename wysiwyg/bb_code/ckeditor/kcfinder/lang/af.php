...
$lang = array(
    ...
    "Jy het nie toestemming om lГЄers op te laai nie oplaai nie.",

    "You don't have permissions to browse server." =>
    "Jy het nie toestemming tot die bediener nie.",

    "Cannot move uploaded file to target folder." =>
    "Jy kannie die lГЄer beweeg na die gids toe nie.",

    "Unknown error." =>
    "Onbekende fout.",

    "The uploaded file exceeds {size} bytes." =>
    "Die foto's lГЄer oorskry {size} grepe.",

    "The uploaded file was only partially uploaded." =>
    "Die foto's lГЄer is slegs gedeeltelik opgelaai.",

    "No file was uploaded." =>
    "Geen lГЄer is opgelaai.",

    "Missing a temporary folder." =>
    "'N tydelike gids ontbreek.",

    "Failed to write file." =>
    "Misluk om lГЄer te kryf.",

    "Denied file extension." =>
    "LГЄer uitbreiding verloГ«n.",
    ...
    "Verkeerde .htaccess lГЄer. Kan nie herskryf dit!",
    ...
    "Ongeoorloofd karakters in die lГЄernaam.",

    "File name shouldn't begins with '.'" =>
    "LГЄer naam moet nie begin met '.'",

    "Are you sure you want to delete this file?" =>
    "Is jy seker jy wil hierdie lГЄer te verwyder ?",
    ...
    "Jy kan nie sulke lГЄers oplaai.",

    "The file '{file}' does not exist." =>
    "Die lГЄer '{file}' bestaan вЂ‹вЂ‹nie.",
    ...
    "Hierdie lГЄer is reeds aan die Klembord bygevoeg.",
    ...
    "Is jy seker jy wil al die lГЄers in die Klembord te verwyder?",

    "Copy {count} files" =>
    "Kopieer {count} lГЄers",
    ...
    "Date" => "Datum",
    "Descending" => "Aflopend",
    "Uploading file..." => "LГЄer Besig Met Oplaai...",
    "Loading image..." => "Besig om beeld te laai...",
    "Loading folders..." => "Besig om Gidse te laai...",
    "Loading files..." => "Besig om LГЄers te laai...",
    ...
    "Die lГЄers in die Klembord is nie leesbaar is.",

    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" =>
    "{count} lГЄers in die Klembord is nie leesbaar is. Wil jy die res te kopieer ?",

    "The files in the Clipboard are not movable." =>
    "Die lГЄers in die Klembord kan verskuif word nie.",

    "{count} files in the Clipboard are not movable. Do you want to move the rest?" =>
    "{count} lГЄers in die Klembord kan nie verskuif word nie. Wil jy die res te beweeg ?",

    "The files in the Clipboard are not removable." =>
    "Die lГЄers in die Klembord kan nie verwyder word nie.",

    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" =>
    "{count} lГЄers in die Klembord kan nie verwyder word nie. Wil jy die res te verwyder ?",

    "The selected files are not removable." =>
    "Die geselekteerde lГЄers kan nie verwyder word nie",

    "{count} selected files are not removable. Do you want to delete the rest?" =>
    "{count} geselekteerde lГЄers kan nie verwyder word nie. Wil jy die res te verwyder ?",

    "Are you sure you want to delete all selected files?" =>
    "Is jy seker jy wil all geselekteerde lГЄers te verwyder ?",

    "Failed to delete {count} files/folders." =>
    "Misluk {count} lГЄers/gidse te verwyder.",

    "A file or folder with that name already exists." =>
    "'N lГЄer of gids met daardie naam bestaan вЂ‹вЂ‹reeds.",

    "Inexistant or inaccessible folder." =>
    "Nie-bestaande of ontoeganklik gids.",

    "selected files" => "geselekteerde lГЄers",
    "Type" => "Tipe",
    "Select Thumbnails" => "Kies duimnaels",
    "Download files" => "Laai lГЄers af",
);
