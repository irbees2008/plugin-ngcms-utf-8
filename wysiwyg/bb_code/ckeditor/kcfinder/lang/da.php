...
$lang = array(
    ...
    "Denied file extension." => "NГ¦gtet filtypenavn.",
    "Unknown image format/encoding." => "Ukendt billedformat / kodning.",
    "The image is too big and/or cannot be resized." => "Billedet er for stort og / eller kan ikke Г¦ndres.",
    "Cannot create {dir} folder." => "Kan ikke lave mappen {dir}.",
    "Cannot rename the folder." => "Kan ikke omdГёbe mappen.",
    "Cannot write to upload folder." => "Kan ikke skrive til upload mappen.",
    "Cannot read .htaccess" => "Ikke kan lГ¦se .htaccess",
    "Incorrect .htaccess file. Cannot rewrite it!" => "Forkert .htaccess fil. Kan ikke omskrive den!",
    "Cannot read upload folder." => "Kan ikke lГ¦se upload mappen.",
    "Cannot access or create thumbnails folder." => "Kan ikke fГҐ adgang til eller oprette miniature mappe.",
    "Cannot access or write to upload folder." => "Kan ikke fГҐ adgang til eller skrive til upload mappe.",
    ...
    "Folder name shouldn't begins with '.'" => "Mappenavne bГёr ikke begynde med '.'",
    "Please enter new file name." => "Indtast venligst nyt filnavn.",
    "Unallowable characters in file name." => "Ugyldige tegn i filens navn",
    "File name shouldn't begins with '.'" => "Filnavn bГёr ikke begynde med '.'",
    "Are you sure you want to delete this file?" => "Er du sikker pГҐ du vil slette denne fil?",
    "Are you sure you want to delete this folder and all its content?" => "Er du sikker pГҐ du vil slette denne mappe og al dens indhold?",
    ...
    "Opening fileinfo database failed." => "Г…bning af filinfo database mislykkedes.",
    "You can't upload such files." => "Du kan ikke uploade sГҐdanne filer.",
    "The file '{file}' does not exist." => "Filen '{file}' eksisterer ikke.",
    "Cannot read '{file}'." => "Kan ikke lГ¦se '{file}'.",
    ...
    "This file is already added to the Clipboard." => "Denne fil er allerede fГёjet til udklipsholderen.",
    "The files in the Clipboard are not readable." => "Filerne i udklipsholderen ikke kan lГ¦ses.",
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{count} filer i udklipsholderen ikke kan lГ¦ses. Г�nsker du at kopiere resten?",
    "The files in the Clipboard are not movable." => "Filerne i udklipsholderen kan ikke flyttes.",
    "{count} files in the Clipboard are not movable. Do you want to move the rest?" => "{count} filer i udklipsholderen er ikke flytbare. Г�nsker du at flytte resten?",
    "The files in the Clipboard are not removable." => "Filerne i udklipsholderen kan ikke fjernes.",
    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" => "{count} filer i udklipsholderen kan ikke fjernes. Г�nsker du at slette resten?",
    "The selected files are not removable." => "De valgte filer er ikke flytbare.",
    "{count} selected files are not removable. Do you want to delete the rest?" => "{count} valgte filer kan ikke fjernes. Г�nsker du at slette resten?",
    "Are you sure you want to delete all selected files?" => "Er du sikker pГҐ du vil slette alle markerede filer?",
    ...
    "Clear the Clipboard" => "TГёm udklipsholderen",
    "Are you sure you want to delete all files in the Clipboard?" => "TГёm udklipsholderen?",
    "Copy {count} files" => "Kopier {count} filer",
    "Move {count} files" => "Flyt {count} filer",
    "Add to Clipboard" => "TilfГёj til udklipsholderen",
    "Inexistant or inaccessible folder." => "Manglende eller utilgГ¦ngelig mappe.",
    ...
    "Loading image..." => "IndlГ¦ser billede...",
    "Loading folders..." => "IndlГ¦ser mapper...",
    "Loading files..." => "IndlГ¦ser filer...",
    ...
    "Cancel" => "Fortryd",
    "Select" => "VГ¦lg",
    "Select Thumbnail" => "VГ¦lg miniature",
    "Select Thumbnails" => "VГ¦lg miniaturer",
    "View" => "Г…ben",
    "Download" => "Download",
    "Download files" => "Download filer",
    "Clipboard" => "Udklipsholder",
    "Checking for new version..." => "SГёger efter ny version...",
    ...
    "Licenses:" => "Licenser:",
    "Attention" => "Vigtigt",
    "Question" => "SpГёrgsmГҐl",
    "Yes" => "Ja",
    "No" => "Nej",
    "You cannot rename the extension of files!" => "Du kan ikke Г¦ndre typen pГҐ filer!",
