...
$lang = array(
    ...
    "The uploaded file was only partially uploaded." => "Il file ГЁ stato caricato parzialmente.",
    "No file was uploaded." => "Nessun file ГЁ stato caricato",
    ...
    "Unknown image format/encoding." => "Il format/encoding dell'immagine ГЁ sconosciuto.",
    "The image is too big and/or cannot be resized." => "L'immagine ГЁ troppo grande e/o non puГІ essere rimpicciolita",
    "Cannot create {dir} folder." => "La cartella {dir} non puГІ essere creata.",
    "Cannot rename the folder." => "Non ГЁ possibile rinominare la cartella.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Il file .htaccess ГЁ corrotto. Impossibile riscriverlo!",
    ...
    "Folder name shouldn't begins with '.'" => "Il nome della cartella non puГІ iniziare con'.'",
    ...
    "File name shouldn't begins with '.'" => "Il nome del file non puГІ iniziare con '.'",
    ...
    "You can't upload such files." => "Non ГЁ possibile caricare questi files.",
    ...
    "Cannot delete the folder." => "Non ГЁ possibile cancellare la cartella.",
    "Click to remove from the Clipboard" => "Click per rimuoverlo dalla Clipboard",
    "This file is already added to the Clipboard." => "Questo file ГЁ giГ  stato aggiunto alla Clipboard.",
    ...
    "The selected files are not removable." => "Il file selezionato non ГЁ rimovibile.",
    ...
    "A file or folder with that name already exists." => "Un file o cartella con questo nome giГ  esiste.",
    ...
    "Inexistant or inaccessible folder." => "La cartella non esiste o ГЁ inacessibile.",
    ...
    "KCFinder is up to date!" => "KCFinder ГЁ aggiornato!",
    "Licenses:" => "Licenze:",
    ...
    "Failed to upload {filename}!" => "Il caricamento del file {filename} ГЁ fallito ",
    "Close" => "Chiudi",
    "Previous" => "Precedente",
    "Next" => "Successivo",
