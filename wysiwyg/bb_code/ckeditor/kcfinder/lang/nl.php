...
$lang = array(
    ...
    "Cannot copy '{file}'." => "Kan bestand '{file}' niet kopiГ«ren.",
    ...
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{count} bestanden op het klembord zijn niet leesbaar. Wilt u de rest toch kopiГ«ren?",
