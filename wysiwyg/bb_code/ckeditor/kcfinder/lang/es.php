...
$lang = array(
    ...
    "The uploaded file exceeds {size} bytes." => "El archivo excede el tamaГ±o permitido ({size} bytes).",
    "The uploaded file was only partially uploaded." => "El archivo solo fuГ© parcialmente cargado.",
    "No file was uploaded." => "El archivo no fuГ© cargado.",
    "Missing a temporary folder." => "No se puede encontrar el directorio temporal.",
    "Failed to write file." => "No se pudo crear el archivo.",
    "Denied file extension." => "ExtensiГіn de archivo denegada.",
    "Unknown image format/encoding." => "Formato / codificaciГіn de imagen desconocido.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Archivo .htaccess incorrecto. ВЎNo puede sobreescribirlo!",
    ...
    "Unallowable characters in folder name." => "Caracteres invГЎlidos en el nombre de carpeta.",
    ...
    "Unallowable characters in file name." => "CarГЎcteres invГЎlidos en el nombre de archivo.",
    ...
    "Fileinfo PECL extension is missing." => "Archivo PECL con estructura errГіnea.",
    "Opening fileinfo database failed." => "Error abriendo el archivo de informaciГіn de la base de datos.",
    ...
    "This file is already added to the Clipboard." => "Este archivo ya fuГ© agregado al portapapeles.",
    ...
    "Failed to delete {count} files/folders." => "FallГі al borrar {count} archivos/carpetas.",
    "A file or folder with that name already exists." => "Existe una carpeta o archivo con el mismo nombre.",
    "Copy files here" => "Copiar archivos aquГ­",
    "Move files here" => "Mover archivos aquГ­",
    ...
    "Unable to connect!" => "ВЎNo se pudo realizar la conexiГіn!",
    "Download version {version} now!" => "ВЎDescarga la versiГіn {version} ahora!",
    "KCFinder is up to date!" => "ВЎKCFinder estГЎ actualizado!",
    "Licenses:" => "Licencias:",
    "Attention" => "AtenciГіn",
    "Question" => "Pregunta",
    "Yes" => "Si",
    "No" => "No",
    "You cannot rename the extension of files!" => "ВЎUsted no puede renombrar la extensiГіn de los archivos!",
    "Uploading file {number} of {count}... {progress}" => "Cargando archivo {number} de {count}... {progress}",
    "Failed to upload {filename}!" => "ВЎNo se pudo cargar el archivo {filename}!",
);
