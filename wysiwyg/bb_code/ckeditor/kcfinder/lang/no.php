...
$lang = array(
    ...
    "Du har ikke tilgang til ГҐ laste opp filer",

    "You don't have permissions to browse server." =>
    "Du har ikke tilgang til ГҐ bla igjennom server",
    ...
    "Ingen tilgang til ГҐ skrive til denne mappen.",
    ...
    "Er du sikker pГҐ at du vil slette denne filen?",

    "Are you sure you want to delete this folder and all its content?" =>
    "Er du sikker pГҐ at du vil slette denne mappen og innholdet i den?",
    ...
    "Klikk for ГҐ fjerne fra utklippstavle",

    "This file is already added to the Clipboard." =>
    "Filen finnes allerede pГҐ utklippstavlen",
    ...
    "Er du sikker pГҐ at du vil slette alle filene i utklippstavlen?",
    ...
    "Kan ikke endre navnet pГҐ mappen.",
    ...
    "{count} filer i utklippstavlen kan ikke leses, Гёnsker du kopiere resten av filene?",
    ...
    "{count} filer i utklippstavlen kan ikke flyttes, Гёnsker du ГҐ flytte resten?",
    ...
    "{count} filer kan ikke flyttes, Гёnsker du ГҐ flytte resten?",

    "Are you sure you want to delete all selected files?" =>
    "Er du sikker pГҐ at du Гёnsker ГҐ slette alle merkede filer?",
