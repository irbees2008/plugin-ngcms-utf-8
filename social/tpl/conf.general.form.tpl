...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="20%" class="contentEntry2"><input type="text" class="form-control" size="35" name="login" value="{login}" /></td>
	</tr>
	<tr>
		<td width="80%" class="contentEntry1">{l_social:bitly.key}<br /><small>{l_social:bitly.key#desc}</small></td>
		<td width="20%" class="contentEntry2"><input type="text" class="form-control" size="35" name="api_key" value="{api_key}" /></td>
	</tr>
</table>
</fieldset>
<fieldset>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="20%" class="contentEntry2"><input type="text" class="form-control" size="25" name="cacheExpire" value="{cacheExpire}" /></td>
	</tr>
</table>
</fieldset>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
