...
<tr class="contRow1">
  ...
  <td width="47%">
    <input type="text" class="form-control" name="name" value="{{ field.name }}" size="40" {% if (not flags.addField) %}readonly{% endif %}>{% if (not flags.addField) %} &nbsp; &nbsp; {{ lang['testmanager:field.noedit'] }}{% endif %}
  </td>
</tr>

<tr class="contRow1">
  <td width="50%">{{ lang['testmanager:field.title'] }}</td>
  <td><input type="text" class="form-control" name="title" value="{{ field.title }}" size="40" /></td>
</tr>
...
<tr class="contRow1"><td>{{ lang['testmanager:field.answer'] }}</td><td><input type="text" class="form-control" name="select_answer" value="{{ field.select_answer }}" size=40></tr>
</table>
</div>
