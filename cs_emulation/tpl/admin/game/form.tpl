<form action="?mod=extra-config&amp;plugin={plugin}&amp;action={action}&amp;tid={tid}&amp;id={id}" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 2px;">
    ...
    <tr>
      ...
      <td class="contentEntry2"><input type="text" class="form-control" size="40" name="map" id="map" value="{map}" /></td>
    </tr>
    <tr>
...
{team2}
    ...
    <tr>
      ...
      <td class="contentEntry2"><input type="text" class="form-control" size="40" name="score[]" id="score1" value="{score1}" /></td>
    </tr>
    <tr>
      <td class="contentEntry1"><label for="score2">Результат #2</label></td>
      <td class="contentEntry2"><input type="text" class="form-control" size="40" name="score[]" id="score2" value="{score2}" /></td>
    </tr>
    <tr>
