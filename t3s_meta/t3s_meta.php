...
function t3s_meta(){
	...
	$t3s_title = $SYSTEM_FLAGS['info']['title']['item'];//для старых версий новость брать по названию
...
/*
//для старых версий, в 9.3 и более новых беру ид $t3s_id = $SYSTEM_FLAGS['news']['db.id'];
