                ...
                <table border="0" cellspacing="0" cellpadding="0" class="filterblock2">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input name="fadress" id="fadress" class="bfname" type="text" value="{{ fadress }}"
                                   size="53"/>
                        </td>
                    </tr>
...
<form action="{{ php_self }}?mod=extra-config&plugin=eshop&action=modify_order" method="post" name="check_order">
    <table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
        <tr class="contHead" align="left">
            ...
            <td width="5%"><input class="check" type="checkbox" name="master_box"
                                  onclick="javascript:check_uncheck_all(check_order)"/></td>
        </tr>
        {% for entry in entries %}
            <tr align="left">
                ...
                <td width="5%" class="contentEntry1"><img
                            src="{{ home }}/engine/skins/default/images/{% if (entry.paid == 1) %}yes.png{% else %}no.png{% endif %}"
                            alt=""></td>
                <td width="5%" class="contentEntry1"><input name="selected_order[]" value="{{ entry.id }}" class="check"
                                                            type="checkbox"/></td>
            </tr>
        {% else %}
            <tr align="left">
