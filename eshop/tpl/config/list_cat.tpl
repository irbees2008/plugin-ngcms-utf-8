    ...
    <table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
        ...
        {% for entry in entries %}
            <tr align="left">
                ...
                <td width="10%" class="contentEntry1">{% if entry.image %}<a href="{{ entry.edit_link }}" ><img
                                src="{{ home }}/uploads/eshop/categories/thumb/{{ entry.image }}" width="100px"
                                height="100px"/></a>{% endif %}</td>
                ...
                <td width="15%" class="contentEntry1"
                    style="text-align:center;vertical-align:middle">{{ entry.catCnt }}</td>
                <td width="15%" class="contentEntry1"
                    style="text-align:center;vertical-align:middle">{{ entry.position }}</td>
                <td width="15%" class="contentEntry1" style="text-align:center;vertical-align:middle"><a
            ...
            <td colspan="8" class="contentEdit" align="right" valign="top">
                <div style="text-align: left;">
                    ...
                    <input class="button" style="float:right; width: 105px;"
                           onmousedown="javascript:window.location.href='{{ admin_url }}/admin.php?mod=extra-config&plugin=eshop&action=add_cat'"
