    ...
    <table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
        ...
        {% for entry in entries %}
            <tr align="left">
                ...
                <td width="25%" class="contentEntry1">{{ entry.rate_from }} $
                    = {{ entry.rate_to|number_format(2, '.', '') }} {{ entry.sign }}</td>
                ...
                <td width="25%" class="contentEntry1"
                    style="text-align:center;vertical-align:middle">{% if (loop.index == 1) %}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{% endif %}
                    <img src="{{ home }}/engine/skins/default/images/{% if (entry.enabled == 1) %}yes.png{% else %}no.png{% endif %}"
                         alt="">{% if (loop.index == 1) %}&nbsp;<img
                    src="{{ home }}/engine/skins/default/images/important.gif" alt="">{% endif %}</td>
            ...
            <td colspan="8" class="contentEdit" align="right" valign="top">
                <div style="text-align: left;">
                    ...
                    <input class="button" style="float:right; width: 105px;"
                           onmousedown="javascript:window.location.href='{{ admin_url }}/admin.php?mod=extra-config&plugin=eshop&action=add_currency'"
