	...
	<form method="post" action="" class="comment-form" name="form" enctype="multipart/form-data">
			<section class="profile-section">
				...
				<div class="line">
					...
					<input type="text" class="form-control" class="text_input" name="announce_name_edit" id="announce_name_edit" value="{{announce_name}}" />
		    		<div class="clear"></div>
			    </div>
				<div class="line">
					<span class="label">Место сбора:</span>
					<input type="text" class="form-control" class="text_input" name="announce_place_edit" id="announce_place_edit" value="{{announce_place}}" />
		    		<div class="clear"></div>
			    </div>
				<div class="line">
					<span class="label">Время сбора:</span>
					<input type="text" class="form-control" class="text_input time ui-timepicker-input" name="announce_timepicker_edit" id="announce_timepicker_edit" autocomplete="off" value="{{time}}" />
		    		<div class="clear"></div>
			    </div>
				<div class="line">
					<span class="label">Дата:</span>
					<input type="text" class="form-control" class="text_input datepicker" name="announce_datepicker_edit" id="announce_datepicker_edit" value="{{date}}">
		    		<div class="clear"></div>
			    </div>
				<div class="line">
