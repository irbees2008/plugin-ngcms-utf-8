		...
		<thead class="thead-dark">
			...
			<div class="card-footer">
				<div class="row">
					...
					<div class="col-lg-6">
						<a href="{{ admin_url }}/admin.php?mod=extra-config&plugin=eshop&action=add_delivery_type" style="float:right;" class="btn btn-outline-success">Добавить способ доставки</a>
					</div>
				</div>
			</div>
</form>