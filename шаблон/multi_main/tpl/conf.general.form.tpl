			...
			<div class="card-body">
				<table class="table table-sm">
					<tr>
						...
						<td><input type="text" class="form-control" size="80" name="main" value="{main}" />
						</td>
					</tr>
					<tr>
						...
						<td><input type="text" class="form-control" size="80" name="guest" value="{guest}" /></td>
					</tr>
					<tr>
						<td>{l_multi_main:label_coment}<br />
							<small>{l_multi_main:desc_coment}</small>
						</td>
						<td><input type="text" class="form-control" size="80" name="coment" value="{coment}" /></td>
					</tr>
					<tr>
						<td>{l_multi_main:label_journ}<br />
							<small>{l_multi_main:desc_journ}</small>
						</td>
						<td><input type="text" class="form-control" size="80" name="journ" value="{journ}" /></td>
					</tr>
					<tr>
						<td>{l_multi_main:label_moder}<br />
							<small>{l_multi_main:desc_moder}</small>
						</td>
						<td><input type="text" class="form-control" size="80" name="moder" value="{moder}" /></td>
					</tr>
					<tr>
						<td>{l_multi_main:label_admin}<br />
							<small>{l_multi_main:desc_admin}</small>
						</td>
						<td><input type="text" class="form-control" size="80" name="admin" value="{admin}" /></td>
					</tr>
				</table>
			</div>
