...
function widgetedit()
{
	...
	$pvars['vars']['if_rand_list'] = MakeDropDown(array(0 => $lang['gmanager:label_no'], 1 => $lang['gmanager:label_yes']), 'if_rand', $if_rand);
...
function widgeteditsubmit()
{
	...
	if (!isset($_POST['name']) || !isset($_POST['title']) || !isset($_POST['if_active'])  || !isset($_POST['skin']) || !isset($_POST['cells']) || !isset($_POST['rows']) || !isset($_POST['if_rand']) || !isset($_POST['galery'])) return;
