...
<tr>
<td class="contentEntry1" valign=top>Количество объявлений в фильтре<br /></td>
<td class="contentEntry2" valign=top><input name="count_filter" type="text" title="Количество объявлений на странице" size="4" value="{count_filter}" /></td>
</tr>
<tr>
<td class="contentEntry1" valign=top>Количество объявлений в архиве<br /></td>
<td class="contentEntry2" valign=top><input name="count_filter_archive" type="text" title="Количество объявлений на странице" size="4" value="{count_filter_archive}" /></td>
</tr>
<tr>
