...
function showlist()
{
	...
	foreach ($full_tree as $node) {
		...
		$access = '';
		if (!($node['access'] & 0x01)) $access .= '<font color="red">Г</font>';
		else $access .= '<font color="green">Г</font>';
		if (!($node['access'] & 0x02)) $access .= '<font color="red">К</font>';
		else $access .= '<font color="green">К</font>';
		if (!($node['access'] & 0x04)) $access .= '<font color="red">Ж</font>';
		else $access .= '<font color="green">Ж</font>';
		if (!($node['access'] & 0x08)) $access .= '<font color="red">Р</font>';
		else $access .= '<font color="green">Р</font>';
		if (!($node['access'] & 0x10)) $access .= '<font color="red">А</font>';
		else $access .= '<font color="green">А</font>';
