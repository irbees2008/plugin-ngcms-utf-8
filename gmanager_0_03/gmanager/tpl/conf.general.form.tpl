...
<tr>
<td width="50%" class="contentEntry1">{l_gmanager:label_locate_tpl}<br /><small>{l_gmanager:desc_locate_tpl}</small></td>
...
<tr>
<td width="50%" class="contentEntry1">{l_gmanager:label_if_keywords}<br /><small>{l_gmanager:desc_if_keywords}</small></td>
