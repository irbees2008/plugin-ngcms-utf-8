...
<tr>
<td width="50%" class="contentEntry1">{l_gmanager:label_name}<br /><small>{l_gmanager:desc_name}</small></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
<td width="50%" class="contentEntry1">{l_gmanager:label_id_icon}<br /><small>{l_gmanager:desc_id_icon}</small></td>
...
<td width="50%" class="contentEntry2">{if_number_list}</td>
</tr>
</table></fieldset><br />
<fieldset>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
<td width="50%" class="contentEntry1">{l_gmanager:label_description}<br /><small>{l_gmanager:desc_description}</small></td>
<td width="50%" class="contentEntry2"><TEXTAREA NAME="description" COLS="80" ROWS="5">{description}</TEXTAREA></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{l_gmanager:label_keywords}<br /><small>{l_gmanager:desc_keywords}</small></td>
<td width="50%" class="contentEntry2"><TEXTAREA NAME="keywords" COLS="80" ROWS="5">{keywords}</TEXTAREA></td>
</tr>
</table>
</fieldset>
