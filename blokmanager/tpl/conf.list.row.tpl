...
<input type="image" src="{admin_url}/plugins/blokmanager/tpl/images/copy.png" title="{l_blokmanager:copy}"  onmousedown="if(window.confirm('Вы уверены что хотите создать копию этого блока?')){ window.location.href='{admin_url}/admin.php?mod=extra-config&plugin=blokmanager&action=copy&id={id}'; } return false;" />
</td>
</tr>
