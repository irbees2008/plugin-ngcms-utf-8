				...
				<div id="brdtitle" class="inbox">
					<table style="border: 0px;" width="99%" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding: 0px; margin:0px; border: 0px;" align="right">
								<a href="{{ rss_feed }}"><img src="{{ css }}/img/rss.png" border="0" height="32" width="32" alt="rss"/></a>
							</td>
						</tr>
					</table>
				</div>
									...
									<table cellpadding="0" cellspacing="0" width="100%" align="left">
										...
										<tr>
											<td class="desc" style="padding: 3px;  border:0px ">
												<a href="{{ entry.link_news }}">{% if (entry.create_data > global.user['last']) %}
													<span style="color:red;">{% endif %}{{ entry.title }}{% if (entry.create_data > global.user['last']) %}</span>{% endif %}
												</a></td>
										<tr>
											{% else %}
										<tr>
							...
							<td class="row1" valign="top">
								<table cellpadding="0" cellspacing="0" width="100%" align="left">
									...
									{% for entry in entries_active_user %}
										<tr>
											<td class="desc" style="padding: 3px;  border:0px ">
												<a href="{{ entry.profile_link }}">{{ entry.color_start }}{{ entry.profile }}{{ entry.color_end }}</a>
											</td>
							...
							<td class="row1" valign="top">
								<table cellpadding="0" cellspacing="0" width="100%" align="left">
									...
									{% for entry in entries_last_topic %}
										<tr>
											<td width="60%" class="desc" style="padding: 3px; border:0px">
												<a href="{{ entry.topic_link }}">{{ entry.subject }}</a></td>
											<td width="15%" class="desc" style="padding: 3px; border:0px">
